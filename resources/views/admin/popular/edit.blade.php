...
<body>
    ...
    <form class="row g-3 needs-validation" novalidate action="/en-db-popular/save-edit" method="POST">
        @csrf
        <input type="hidden" class="form-control" id="id" name="id" value="{{ $popular->id }}" required>
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="validationCustom02" name="validationCustom02"
                value="{{ $popular->animeId }}" required>
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="validationCustom03" name="validationCustom03"
                value="{{ $popular->animeTitle }}" required>
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="validationCustom04" name="validationCustom04"
                value="{{ $popular->animeImg }}" required>
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="validationCustom05" name="validationCustom05"
                value="{{ $popular->releasedDate }}" required>
