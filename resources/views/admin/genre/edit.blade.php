    ...
    <form class="row g-3 needs-validation" novalidate action="/en-db-genre/save-edit" method="POST">
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control disabled-input" id="validationCustom02" name="validationCustom02"
                value="{{ $GenreEn->animeId }}" required>

        </div>

        <div class="col-md-12">
            <label for="validationCustom01" class="form-label">Anime Title</label>
            <input type="text" class="form-control" id="validationCustom03" name="validationCustom03"
                value="{{ $GenreEn->animeTitle }}" required>

        </div>

        <div class="col-md-12">
            <label for="validationCustom01" class="form-label">Anime Image</label>
            <input type="text" class="form-control" id="validationCustom04" name="validationCustom04"
                value="{{ $GenreEn->animeImg }}" required>

        </div>

        <div class="col-md-12">
            <label for="validationCustom01" class="form-label">Release Date</label>
            <input type="text" class="form-control" id="validationCustom05" name="validationCustom05"
                value="{{ $GenreEn->releasedDate }}" required>
