...
<body>
    ...
    <form class="row g-3 needs-validation" novalidate action="{{ route('enanimupdate') }}" method="POST">
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="animeId" name="animeId" value="{{ $anim->animeId }}"
                required>
        </div>

        <div class="col-md-12">
            <label for="animeTitle" class="form-label">Anime Title</label>
            <input type="text" class="form-control" id="animeTitle" name="animeTitle" value="{{ $anim->animeTitle }}"
                required>
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="type" name="type" value="{{ $anim->type }}"
                required>
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="animeImg" name="animeImg" value="{{ $anim->animeImg }}"
                required>
        </div>

        <div class="col-md-12">
            <label for="releasedDate" class="form-label">Released Date</label>
            <input type="text" class="form-control" id="releasedDate" name="releasedDate"
                value="{{ $anim->releasedDate }}" required>
        </div>

        <div class="col-md-12">
            <label for="status" class="form-label">Status</label>
            <input type="text" class="form-control" id="status" name="status" value="{{ $anim->status }}"
                required>
        </div>

        <div class="col-md-12">
            <label for="genres" class="form-label">Genre</label>
            <input type="text" class="form-control" id="genres" name="genres" value="{{ $anim->genres }}"
                required>
        </div>

        <div class="col-md-12">
            <label for="otherNames" class="form-label">Other Name</label>
            <input type="text" class="form-control" id="otherNames" name="otherNames" value="{{ $anim->otherNames }}"
                required>
        </div>
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="totalEpisodes" name="totalEpisodes"
                value="{{ $anim->totalEpisodes }}" required>
        </div>
