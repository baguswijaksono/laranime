        ...
        if ($totalPages <= 0) {
            ...
            for ($page = $minPages; $page <= $totalPages; $page++) {
                ...
                echo "<script>
                    ...
                    document.getElementsByClassName('logdata')[0].innerHTML = 'recent-release Anime Data inserted successfully for recent-release page $page';
                    ...
                    if (" . $percent . " === 100) {
                        ...
                        button1.href = 'http://localhost/eslolin/scraper/add_recent-release.php'; // Set the href attribute to the desired URL
