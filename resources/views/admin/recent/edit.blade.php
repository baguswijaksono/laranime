    ...
    <form class="row g-3 needs-validation" novalidate action="/en-db-recent/save-edit" method="POST">
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="validationCustom03" name="validationCustom03"
                value="{{ $Recent->animeTitle }}" required>
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="validationCustom04" name="validationCustom04"
                value="{{ $Recent->animeImg }}" required>
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="validationCustom05" name="validationCustom05"
                value="{{ $Recent->episodeNum }}" required>

        </div>

        <div class="col-md-12">
            <label for="validationCustom01" class="form-label">Sub or Dub</label>
            <input type="text" class="form-control" id="validationCustom06" name="validationCustom06"
                value="{{ $Recent->subOrDub }}" required>
