...
@endphp
    ...
    @else
      ...
      <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop2">Add Genre</button>
          ...
          <div class="modal-content">
            ...
            <form method="POST" action="{{ route('genre.add') }}">
              ...
              <div class="modal-body">
                ...
                <input class="form-control" name="name" type="text" placeholder="Default input" aria-label="default input example">
                <input class="form-control" name="slug" type="text" placeholder="Default input" aria-label="default input example">
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
