                    ...
                    <div class="col">
                        ...
                        <div style="padding-left: 15px; padding-top: 15px; display: inline-block;">
                            <div class="card" style=" width: 175px;">
                                <a href="/en/anime-details/{{ $item }}"> <img src="{{ $anim->animeImg }}"
                                        class="rounded" alt="" style="height : 250px; width: 175px;">
                                ...
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#staticBackdrop_{{ $item }}">
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="staticBackdrop_{{ $item }}"
                                        data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                        aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="staticBackdropLabel">Delete Watchlist
                                                        Confirmation</h5>
